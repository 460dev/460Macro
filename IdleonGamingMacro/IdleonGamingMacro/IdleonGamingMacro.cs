...
//            {
//                #region harvest all
//                bool harvestResult = ExecuteMacroProcess(bounds, gameX, gameY, gamingWidth, gamingHeight, HarvestAllImagePath, 0.7);
//                #endregion

//                #region sprinkler max
//                bool sprinklerMaxResult = ExecuteMacroProcess(bounds, 0, 0, 800, 480, SprinklerMaxImagePath, 0.7, scale: 0.8, mouseClick: false);
//                if (!sprinklerMaxResult)
//                {
//                    #region chemical
//                    bool chemicalResult = ExecuteMacroProcess(bounds, gameX, gameY, gamingWidth, gamingHeight, ChemicalImagePath, 0.4, scale: 0.9); // Chemical
//                    #endregion
//                }
//                #endregion
...
//                {
//                    #region sprinkler
//                    var sprinklerResult = ExecuteMacroProcess(bounds, gameX, gameY, gamingWidth, gamingHeight, SprinklerImagePath, 0.7); // Sprinkler
//                    #endregion
//                }
//                #endregion

//                #region squirrel
//                var squirrelResult = ExecuteMacroProcess(bounds, gameX, gameY, gamingWidth, gamingHeight, SquirrelImagePath, 0.5);     // Squirrel
//                #endregion

//                #region shovel
//                ExecuteMacroProcess(bounds, gameX, gameY, gamingWidth, gamingHeight, ShovelNoEffectImagePath, 0.5);   // Shovel button
//                #endregion
